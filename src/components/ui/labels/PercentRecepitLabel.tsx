...
export type LabelProps = JSX.IntrinsicElements["label"] & {
    variant?: "primary" | "red" | "blue" | "netural" | "tertiary";
    size?: "sm" | "md" | "lg";
    title?: string;
    value?: string | number;

}
export const PercentRecepitLabel: React.FC<LabelProps> = ({
    children,
    title,
    variant = "primary",
    size = "md",
    ...
    return (
        <InfoBox>
            <div className="head">
                <div className="row">
                    <div className="text">
                        <SimpleLabel className="text-info" variant={variant}>{title}</SimpleLabel>
                        <div className="line"></div>

                        <SimpleLabel variant="netural">{`${value}%`}</SimpleLabel>
